...
MAPPING = {
    ...
    "recsys/recommendations/" + FILES_TO_DOWNLOAD[1]: DOWNLOAD_DIR + FILES_TO_DOWNLOAD[1],
    "recsys/recommendations/" + FILES_TO_DOWNLOAD[2]: DOWNLOAD_DIR + FILES_TO_DOWNLOAD[2],
    "recsys/recommendations/" + FILES_TO_DOWNLOAD[3]: DOWNLOAD_DIR + FILES_TO_DOWNLOAD[3],
}
